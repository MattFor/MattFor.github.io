...
window.RELAXY_COMMANDS = {
    ...
    'ticketsystem': {
        'u': '=ticketsystem',
        'd': 'Initiate a channel with a server wide ticket queue which will be processed by Relaxy!\n\nA proper description for this command will be written some day, but that day is most definitely not today so if you want to inquire on how to use it contact @mattfor on Discord.'
    },
    'toolkit': {
